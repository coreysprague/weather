...
protocol WeatherService {
	func getWeatherByCity(city: String,
	                      completion: @escaping (_ forecast: CurrentWeatherResponse) -> Void,
	...
	func getWeatherByZipcode(zipCode: Int,
	                         completion: @escaping (_ forecast: CurrentWeatherResponse) -> Void,
	                         failure: @escaping (Error) -> Void)

	func getWeatherByCityId(cityId: Int,
	                        completion: @escaping (_ forecast: CurrentWeatherResponse) -> Void,
	                        failure: @escaping (Error) -> Void)
...
class OpenWeatherMapService: WeatherService {
	...
	private func getWeather(queryParams: [String:String],
	                        completion: @escaping (_ forecast: CurrentWeatherResponse) -> Void,
	                        failure: @escaping (Error) -> Void) {
	...
	private func getCurrentWeatherResponse(_ json: JSON) -> CurrentWeatherResponse {
		...
		for (_, subJson) in json["weather"] {
			let weatherCondition = WeatherCondition(
					conditionId: subJson["id"].intValue,
					main: subJson["main"].stringValue,
